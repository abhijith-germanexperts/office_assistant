...
List<Directory> directoryFromJson(String str) => List<Directory>.from(json.decode(str).map((x) => Directory.fromJson(x)));

String directoryToJson(List<Directory> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
