...
// Make sure your imports match your file structure
...
// --- FIXED SIGNATURE: ADDED 'status' BACK ---
Widget customListExpanded(
    BuildContext context, DirecotoryModelDatum directory, Future<Crmuserslogin> status) {
          ...
          child: Theme(
            ...
            child: ExpansionTile(
              ...
              title: !isexpanded
                ...
                children: [
                  // ==========================================
                  // 1. ADDED MAIN ROW AVATAR + NAME
                  // ==========================================
                  Expanded(
                    child: Padding(
                      // THIS padding pushes the avatars inward so they align nicely under the "Name" header
                      padding: const EdgeInsets.only(left: 30.0),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.start, // Keeps avatars in a perfect vertical line
                        children: [
                          CircleAvatar(
                            radius: 16,
                            backgroundColor: const Color(0xff303030),
                            backgroundImage: (directory.imgpath != null && directory.imgpath!.isNotEmpty && directory.imgpath != "null")
                                ? NetworkImage(directory.imgpath!)
                                : NetworkImage('https://ui-avatars.com/api/?name=${directory.employeename ?? "Emp"}&background=random&color=fff&size=128') as ImageProvider,
                            onBackgroundImageError: (e, s) {},
                          ),
                          const SizedBox(width: 15), // Gives breathing room between avatar and text

                          Expanded( // Changed from Flexible to Expanded to handle long names perfectly
                            child: Text(
                        ...
                        child: Container(
                          ...
                          child: CircleAvatar(
                            ...
                            onBackgroundImageError: (exception, stackTrace) {
                              // Silently handle broken image URLs
                            },
                          ),
                        ),
                      ),
