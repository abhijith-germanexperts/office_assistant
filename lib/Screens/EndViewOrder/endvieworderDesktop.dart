                                ...
                                itemBuilder: (cntxt, index) {
                                  return Container(
                                    ...
                                    child: Row(
                                      crossAxisAlignment: CrossAxisAlignment.center,
                                      children: [
                                        // 1. Fixed Image rendering with error handling
                                        SizedBox(
                                          height: height * .08,
                                          width: height * .08,
                                          child: ClipRRect(
                                            borderRadius: BorderRadius.circular(8),
                                            child: cartItems[index].item.itemimgpath != null && cartItems[index].item.itemimgpath!.isNotEmpty
                                                ? Image.network(
                                              cartItems[index].item.itemimgpath!,
                                              fit: BoxFit.cover,
                                        ...
                                        // 2. Expanded Text allows proper pushing of the trailing icons
                                        Expanded(
                                          child: AutoSizeText(
                                            cartItems[index].item.itemname ?? "Unknown Item",
                                        ...
                                        // 3. Counter Controls neatly structured
                                        Row(
                                          mainAxisSize: MainAxisSize.min,
                                          children: [
                                            InkWell(
                                                onTap: () {
                                                  cartProvider.removeFromCart(cartItems[index].item);
                                                },
                                            ...
                                            InkWell(
                                                onTap: () {
                                                  cartProvider.addToCart(cartItems[index].item);
                                                },
                                                child: const Icon(Icons.add, color: Colors.white, size: 24)),
                                            const SizedBox(width: 25),
                                            InkWell(
                                              onTap: () {
                                                cartProvider.removeitem(cartItems[index].item);
                                              },
