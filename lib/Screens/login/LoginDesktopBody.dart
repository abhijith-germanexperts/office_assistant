                                                              ...
                                                              builder:
                                                                ...
                                                                if (snapshot
                                                                  ...
                                                                  if (snapshot.data
                                                                    ...
                                                                    // FIXED LINES: Added null checks and default values for SharedPreferences
                                                                    saveLoginValue(snapshot.data?.userList?.first.userId?.toString() ?? "");
                                                                    saveUserName(snapshot.data?.userList?.first.username?.toString() ?? "");
                                                                    saveRoleid(snapshot.data?.userList?.first.roleId ?? 0);
                                                                    saveCategoryid(snapshot.data?.userList?.first.usercategory ?? 0);
                                                                    saveOfficeid(snapshot.data?.userList?.first.officeid ?? 0);

                                                                    if (snapshot.data?.userList?.first.roleId == 2) {
                                                                      if ((snapshot.data?.userpantryList ?? []).isNotEmpty) {
                                                                        savePantryUserId(snapshot.data?.userpantryList?.first.pantryid ?? 0);
                                                                        AppConstants.userPantryId = getpantryuserId();
                                                                      }
                                                                    }
